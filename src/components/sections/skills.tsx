...
const skills = [
  {
    name: 'Python',
    icon: (
      <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor"><path d="M11.23 2.44a.8.8 0 0 1 .8.8v4.92h2.25a2.26 2.26 0 0 1 2.26 2.26v2.25a.8.8 0 0 1-.8.8h-4.9a.8.8 0 0 1-.8-.8V2.44zm-7.2 7.19a.8.8 0 0 1 .8-.8h4.92v2.25a2.26 2.26 0 0 1-2.26 2.26H4.74a.8.8 0 0 1-.8-.8v-4.91zm7.2 6.56a.8.8 0 0 1 .8.8v4.95a.8.8 0 0 1-1.6 0v-2.7h-2.26a2.26 2.26 0 0 1-2.26-2.26v-2.25a.8.8 0 0 1 .8-.8h4.52zm7.19-7.2a.8.8 0 0 1 .8.8v4.9a.8.8 0 0 1-1.6 0v-2.7h-2.26a2.26 2.26 0 0 1-2.26-2.26V9.6a.8.8 0 0 1 .8-.8h4.52zM12 0a.8.8 0 0 1 .8.8v1.64a.8.8 0 1 1-1.6 0V.8a.8.8 0 0 1 .8-.8zM4.03 4.03a.8.8 0 0 1 1.13 0l1.16 1.16a.8.8 0 1 1-1.13 1.13L4.03 5.16a.8.8 0 0 1 0-1.13zM0 12a.8.8 0 0 1 .8.8h1.64a.8.8 0 1 1 0 1.6H.8a.8.8 0 0 1-.8-.8zm4.03 15.94a.8.8 0 0 1 0-1.13l1.16-1.16a.8.8 0 1 1 1.13 1.13l-1.16 1.16a.8.8 0 0 1-1.13 0zM12 21.56a.8.8 0 0 1 .8.8v1.64a.8.8 0 1 1-1.6 0v-1.64a.8.8 0 0 1 .8-.8zm7.94-15.94a.8.8 0 0 1 1.13 0l1.16 1.16a.8.8 0 1 1-1.13 1.13l-1.16-1.16a.8.8 0 0 1 0-1.13zM21.56 12a.8.8 0 0 1 .8.8h1.64a.8.8 0 1 1 0 1.6h-1.64a.8.8 0 0 1-.8-.8zm-2.47 7.94a.8.8 0 0 1 1.13 1.13l-1.16 1.16a.8.8 0 1 1-1.13-1.13l1.16-1.16z"/></svg>
    ),
  },
  {
    name: 'C',
