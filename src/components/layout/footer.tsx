      ...
      <div className="container px-4 md:px-6 relative z-10 max-w-[1200px] mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 md:gap-8">
          ...
          <div className="space-y-2">
            <h2 className="font-display text-xl md:text-4xl font-bold tracking-tight text-canvas uppercase leading-none">
              C. VISHWAK SENA
            </h2>
          ...
          <div className="flex flex-wrap gap-4 md:gap-8 border-y border-canvas/10 md:border-y-0 py-4 md:py-0 w-full md:w-auto">
            {socialLinks.map((social) => (
              <a
                ...
                className="text-[10px] md:text-xs font-bold tracking-widest uppercase text-canvas/70 hover:text-accent transition-colors"
              >
                {social.label}
              </a>
            ))}
